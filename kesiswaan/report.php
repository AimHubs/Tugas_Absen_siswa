    ...
    <div>
      <div style="width: 100%;">
        <table cellspacing="0"style="width: 100%;">
          <tr>
            <td style="width: 6%;"><img src="http://localhost/Tugas_Absen_siswa/img/<?PHP echo $header_photo['photo']; ?>"style="width: 100%;"></td>
            ...
            <td style="width: 10%;"><img src="http://localhost/Tugas_Absen_siswa/img/tut.png"style="width: 100%;"></td>
          </tr>
        </table>
      ...
      echo '<table cellspacing="0" style="width: 100%; text-align: center; font-size: 10pt">
                     <tr>
                         <td style="width: 30%">Kab.Bogor, '.date('d-m-Y').'</td>
                     ...
                     <tr>
                         ...
                         <td style="width: 40%"></td>
                         <td style="width: 30%"><br><br><br><br>'.$data_laporan['nama_wakil'].'<br>Wakil Kepala Sekolahh</td>
                     </tr>
                 </table>';
       ?>
  </body>
