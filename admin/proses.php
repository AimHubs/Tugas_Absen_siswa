...
if(isset($_GET['kategori'])){
  ...
  }else if($_GET['kategori']=="account_siswa"){
    $query_daftar=mysqli_query($konek,"INSERT INTO account (username,password,id_siswa,id_kelas)
    VALUES ('$_POST[username]','$_POST[password]','$_POST[id_siswa]','$_POST[id_kelas]');");
      if($query_daftar){
...
if(isset($_GET['hapus_siswa'])){
  ...
  Header("location:../admin/wali");
}else if(isset($_GET['hapus_account'])){
  $query_hapus=mysqli_query($konek,"DELETE FROM account WHERE id_account = $_GET[hapus_account]");
  Header("location:../admin/account");
}
...
if(isset($_GET['edit_siswa'])){
  ...
  $query_edit=mysqli_query($konek,"UPDATE account SET username='$_POST[username]',password='$_POST[password]',
    id_siswa=$_POST[id_siswa],id_kelas=$_POST[id_kelas] WHERE id_account=$_GET[edit_account]");
  Header("location:../admin/account");
