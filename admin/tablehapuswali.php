            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="http://localhost/Tugas_Absen_siswa/admin/proses.php?hapus_wali=<?PHP echo $data['id_wali']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="http://localhost/Tugas_Absen_siswa/admin/wali"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
