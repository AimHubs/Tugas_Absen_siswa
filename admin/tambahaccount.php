<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/Tugas_Absen_siswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
    ...
    <a href="http://localhost/Tugas_Absen_siswa/admin/account/add" class="current">Tambah</a> </div>
   <h1>Tambah account siswa</h1>
 </div>
     ...
     <div class="span12">
       ...
       <div class="widget-box">
         <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
           <h5>Tambah account siswa</h5>
         </div>
         <div class="widget-content nopadding">
           <form action="../proses.php?kategori=account_siswa" method="post" class="form-horizontal">
